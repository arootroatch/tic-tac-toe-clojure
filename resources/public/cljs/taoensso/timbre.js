...
var G__18945 = (i__5727__auto___18944 + (1));
i__5727__auto___18944 = G__18945;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq18941){
var G__18942 = cljs.core.first.call(null,seq18941);
var seq18941__$1 = cljs.core.next.call(null,seq18941);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18942,seq18941__$1);
}));
...
var err_18948 = "Invalid Timbre logging level: should be e/o #{:trace :debug :info :warn :error :fatal :report}";
var level__GT_int_18949 = (function (p1__18946_SHARP_){
var G__18947 = p1__18946_SHARP_;
...
if(cljs.core.truth_(level__GT_int_18949.call(null,x))){
return true;
} else {
return false;
}
...
throw cljs.core.ex_info.call(null,err_18948,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"given","given",716253602),x,new cljs.core.Keyword(null,"type","type",1174270348),cljs.core.type.call(null,x)], null));
}
});

taoensso.timbre.valid_level__GT_int = (function taoensso$timbre$valid_level__GT_int(x){
var or__5002__auto__ = level__GT_int_18949.call(null,x);
...
var valid_level__GT_int_18951 = taoensso.timbre.valid_level__GT_int;
/**
 * Implementation detail.
 */
taoensso.timbre.level_GT__EQ_ = (function taoensso$timbre$level_GT__EQ_(x,y){
return (valid_level__GT_int_18951.call(null,x) >= valid_level__GT_int_18951.call(null,y));
});
var fn_QMARK__18956 = cljs.core.fn_QMARK_;
var compile_18957 = taoensso.encore.fmemoize.call(null,(function (x){
return taoensso.encore.name_filter.call(null,x);
}));
var conform_QMARK__STAR__18958 = taoensso.encore.fmemoize.call(null,(function (x,ns){
return compile_18957.call(null,x).call(null,ns);
}));
var conform_QMARK__18959 = (function (ns_filter,ns){
if(cljs.core.truth_(fn_QMARK__18956.call(null,ns_filter))){
return ns_filter.call(null,ns);
} else {
return conform_QMARK__STAR__18958.call(null,ns_filter,ns);
}
});
/**
 * Implementation detail.
...
if(cljs.core.truth_(conform_QMARK__18959.call(null,ns_filter,ns))){
return true;
} else {
return false;
}
...
return taoensso.encore.rsome.call(null,(function (p__18952){
var vec__18953 = p__18952;
var ns_pattern = cljs.core.nth.call(null,vec__18953,(0),null);
var min_level = cljs.core.nth.call(null,vec__18953,(1),null);
if(cljs.core.truth_(conform_QMARK__STAR__18958.call(null,ns_pattern,ns))){
...
var valid_level_18960 = taoensso.timbre.valid_level;
var ns__GT__QMARK_min_level_18961 = taoensso.timbre.ns__GT__QMARK_min_level;
taoensso.timbre.get_min_level = (function taoensso$timbre$get_min_level(default$,x,ns){
return valid_level_18960.call(null,(function (){var or__5002__auto__ = ((cljs.core.vector_QMARK_.call(null,x))?ns__GT__QMARK_min_level_18961.call(null,x,ns):x);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return default$;
...
var ns_whitelist__$1 = leglist_18962.call(null,ns_whitelist);
var ns_blacklist__$1 = leglist_18962.call(null,ns_blacklist);
...
var level_GT__EQ__18965 = taoensso.timbre.level_GT__EQ_;
var may_log_ns_QMARK__18966 = taoensso.timbre.may_log_ns_QMARK_;
var get_min_level_18967 = taoensso.timbre.get_min_level;
var legacy_ns_filter_18968 = taoensso.timbre.legacy_ns_filter;
/**
 * Implementation detail.
...
var min_level = get_min_level_18967.call(null,default_min_level,(function (){var or__5002__auto__ = cljs.core.get.call(null,config,new cljs.core.Keyword(null,"min-level","min-level",1634684919));
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
if(cljs.core.truth_(level_GT__EQ__18965.call(null,level,min_level))){
var temp__5802__auto__ = (function (){var or__5002__auto__ = cljs.core.get.call(null,config,new cljs.core.Keyword(null,"ns-filter","ns-filter",108598448));
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return legacy_ns_filter_18968.call(null,cljs.core.get.call(null,config,new cljs.core.Keyword(null,"ns-whitelist","ns-whitelist",-1717299774)),cljs.core.get.call(null,config,new cljs.core.Keyword(null,"ns-blacklist","ns-blacklist",1957763142)));
}
})();
if(cljs.core.truth_(temp__5802__auto__)){
var ns_filter = temp__5802__auto__;
if(cljs.core.truth_(may_log_ns_QMARK__18966.call(null,ns_filter,_QMARK_ns_str))){
return true;
} else {
return false;
}
...
var min_level_STAR___$1 = cljs.core.reduce.call(null,(function (acc,p__18972){
var vec__18973 = p__18972;
var ns_pattern = cljs.core.nth.call(null,vec__18973,(0),null);
var _pattern_min_level = cljs.core.nth.call(null,vec__18973,(1),null);
var entry = vec__18973;
var temp__5802__auto__ = ((cljs.core._EQ_.call(null,ns_pattern,ns__$1)) || (cljs.core._EQ_.call(null,ns_pattern,cljs.core.PersistentHashSet.createAsIfByAssoc([ns__$1]))));
...
var min_level_STAR___$2 = (function (){var temp__5802__auto__ = ((cljs.core._EQ_.call(null,cljs.core.count.call(null,min_level_STAR___$1),(1)))?(function (){var vec__18976 = min_level_STAR___$1;
var vec__18979 = cljs.core.nth.call(null,vec__18976,(0),null);
var ns_pattern = cljs.core.nth.call(null,vec__18979,(0),null);
var level = cljs.core.nth.call(null,vec__18979,(1),null);
...
var ret__5781__auto___18985 = (function (){
/**
...
return cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,(new cljs.core.List(null,new cljs.core.Symbol("taoensso.timbre","swap-config!","taoensso.timbre/swap-config!",-923245809,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,(new cljs.core.List(null,new cljs.core.Symbol("cljs.core","fn","cljs.core/fn",-1065745098,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec.call(null,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,(new cljs.core.List(null,new cljs.core.Symbol(null,"config__18982__auto__","config__18982__auto__",1653457578,null),null,(1),null)))))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,(new cljs.core.List(null,new cljs.core.Symbol("taoensso.timbre","set-ns-min-level","taoensso.timbre/set-ns-min-level",1904371957,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"config__18982__auto__","config__18982__auto__",1653457578,null),null,(1),null)),(new cljs.core.List(null,cljs.core.str.cljs$core$IFn$_invoke$arity$1(ns),null,(1),null)),(new cljs.core.List(null,_QMARK_min_level,null,(1),null))))),null,(1),null))))),null,(1),null)))));
}));
...
var map__18987 = timestamp_opts;
var map__18987__$1 = cljs.core.__destructure_map.call(null,map__18987);
var pattern = cljs.core.get.call(null,map__18987__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var vec__18988 = vargs;
var v0 = cljs.core.nth.call(null,vec__18988,(0),null);
...
var _QMARK_msg_fmt = ((fmt_msg_QMARK_)?(function (){var vec__18991 = vargs__$1;
var v0__$1 = cljs.core.nth.call(null,vec__18991,(0),null);
return v0__$1;
})():null);
var vargs__$2 = ((fmt_msg_QMARK_)?taoensso.encore.vrest.call(null,vargs__$1):vargs__$1);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [_QMARK_err__$1,_QMARK_meta,_QMARK_msg_fmt,vargs__$2], null);
} else {
var _QMARK_meta = (cljs.core.truth_((function (){var and__5000__auto__ = cljs.core.map_QMARK_.call(null,v0);
...
var _QMARK_msg_fmt = ((fmt_msg_QMARK_)?(function (){var vec__18994 = vargs__$1;
var v0__$1 = cljs.core.nth.call(null,vec__18994,(0),null);
return v0__$1;
})():null);
var vargs__$2 = ((fmt_msg_QMARK_)?taoensso.encore.vrest.call(null,vargs__$1):vargs__$1);
...
}catch (e18997){var t = e18997;
var map__18998 = data;
var map__18998__$1 = cljs.core.__destructure_map.call(null,map__18998);
var level = cljs.core.get.call(null,map__18998__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_ns_str = cljs.core.get.call(null,map__18998__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.call(null,map__18998__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var _QMARK_line = cljs.core.get.call(null,map__18998__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
var _QMARK_column = cljs.core.get.call(null,map__18998__$1,new cljs.core.Keyword(null,"?column","?column",1004649085));
...
var instant_19007 = (new Date());
var context_19008 = taoensso.timbre._STAR_context_STAR_;
var vargs_19009 = cljs.core.deref.call(null,vargs_);
var vec__19001_19010 = taoensso.timbre.parse_vargs.call(null,_QMARK_err,msg_type,vargs_19009);
var _QMARK_err_19011__$1 = cljs.core.nth.call(null,vec__19001_19010,(0),null);
var _QMARK_meta_19012 = cljs.core.nth.call(null,vec__19001_19010,(1),null);
var _QMARK_msg_fmt_19013 = cljs.core.nth.call(null,vec__19001_19010,(2),null);
var vargs_19014__$1 = cljs.core.nth.call(null,vec__19001_19010,(3),null);
var data_19015 = cljs.core.conj.call(null,(function (){var or__5002__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"spying?","spying?",1753444487),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891),new cljs.core.Keyword(null,"?column","?column",1004649085)],[instant_19007,spying_QMARK_,config,vargs_19014__$1,_QMARK_file,cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null),level),_QMARK_ns_str,level,msg_type,_QMARK_err_19011__$1,context_19008,_QMARK_line,_QMARK_meta_19012,_QMARK_msg_fmt_19013,_QMARK_column]));
var _QMARK_data_19016 = cljs.core.reduce.call(null,(function (acc,mf){
...
}),data_19015,cljs.core.get.call(null,config,new cljs.core.Keyword(null,"middleware","middleware",1462115504)));
var temp__5804__auto___19020 = _QMARK_data_19016;
if(cljs.core.truth_(temp__5804__auto___19020)){
var data_19021__$1 = temp__5804__auto___19020;
var map__19004_19022 = data_19021__$1;
var map__19004_19023__$1 = cljs.core.__destructure_map.call(null,map__19004_19022);
var vargs_19024__$2 = cljs.core.get.call(null,map__19004_19023__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_19025__$2 = taoensso.encore.assoc_nx.call(null,data_19021__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
return taoensso.timbre.protected_fn.call(null,"Timbre error when calling (msg-fn <data>)",taoensso.timbre.default_output_msg_fn).call(null,data_19021__$1);
}),null)),new cljs.core.Keyword(null,"hash_","hash_",-827203612),(new cljs.core.Delay((function (){
return cljs.core.hash.call(null,(function (){var b2__1576__auto__ = cljs.core.get.call(null,_QMARK_meta_19012,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var b2__1576__auto____$1 = cljs.core.get.call(null,_QMARK_meta_19012,new cljs.core.Keyword(null,"id!","id!",218090956));
if(cljs.core.truth_(b2__1576__auto____$1)){
var id = b2__1576__auto____$1;
return id;
} else {
var b2__1576__auto____$2 = cljs.core.get.call(null,_QMARK_meta_19012,new cljs.core.Keyword(null,"hash","hash",-13781596));
if(cljs.core.truth_(b2__1576__auto____$2)){
var h = b2__1576__auto____$2;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,callsite_id,_QMARK_msg_fmt_19013,level], null);
} else {
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [vargs_19024__$2,callsite_id,_QMARK_msg_fmt_19013,level], null);
}
}
}
})());
}),null)));
var get_timestamp_delay_19026 = (function (){var get_shared_delay = taoensso.encore.fmemoize.call(null,(function (opts){
return (new cljs.core.Delay((function (){
return taoensso.timbre.get_timestamp.call(null,opts,cljs.core.get.call(null,data_19025__$2,new cljs.core.Keyword(null,"instant","instant",655498374)));
}),null));
}));
...
var get_output_fn_19027 = (function (){var base_fn = taoensso.encore.fmemoize.call(null,cljs.core.get.call(null,config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
var base_output_opts_19028 = cljs.core.get.call(null,config,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
cljs.core.reduce_kv.call(null,(function (_,id,appender){
if(cljs.core.truth_((function (){var and__5000__auto__ = cljs.core.get.call(null,appender,new cljs.core.Keyword(null,"enabled?","enabled?",-1376075057));
...
var rate_limit_okay_QMARK_ = (function (){var or__5002__auto__ = cljs.core.empty_QMARK_.call(null,rate_limit_specs);
if(or__5002__auto__){
return or__5002__auto__;
} else {
var rl_fn = taoensso.timbre.get_rate_limiter.call(null,id,rate_limit_specs);
return cljs.core.not.call(null,rl_fn.call(null,cljs.core.force.call(null,cljs.core.get.call(null,data_19025__$2,new cljs.core.Keyword(null,"hash_","hash_",-827203612)))));
}
})();
if(rate_limit_okay_QMARK_){
var map__19005 = appender;
var map__19005__$1 = cljs.core.__destructure_map.call(null,map__19005);
var apfn = cljs.core.get.call(null,map__19005__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.call(null,map__19005__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
var timestamp_ = get_timestamp_delay_19026.call(null,cljs.core.get.call(null,appender,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807)));
var output_fn = get_output_fn_19027.call(null,cljs.core.get.call(null,appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539)));
var output_opts = (function (){var or__5002__auto__ = cljs.core.get.call(null,appender,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return base_output_opts_19028;
}
})();
var output_ = (new cljs.core.Delay((function (){
return output_fn.call(null,cljs.core.assoc.call(null,data_19025__$2,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325),output_opts));
}),null));
var data__$3 = cljs.core.conj.call(null,data_19025__$2,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325),output_opts,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_], null));
var _QMARK_data__$1 = (function (){var temp__5802__auto__ = cljs.core.get.call(null,appender,new cljs.core.Keyword(null,"middleware-fn","middleware-fn",-61585752));
if(cljs.core.truth_(temp__5802__auto__)){
...
var map__19033 = data;
var map__19033__$1 = cljs.core.__destructure_map.call(null,map__19033);
var level = cljs.core.get.call(null,map__19033__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.call(null,map__19033__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var _QMARK_ns_str = cljs.core.get.call(null,map__19033__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.call(null,map__19033__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.call(null,map__19033__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.call(null,map__19033__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.call(null,map__19033__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
var output_opts = cljs.core.get.call(null,map__19033__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
return [(function (){var temp__5804__auto__ = cljs.core.force.call(null,timestamp_);
...
})(),clojure.string.upper_case.call(null,cljs.core.name.call(null,level))," ","[",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__5002__auto__ = _QMARK_ns_str;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
})()),"] - ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var temp__5804__auto__ = cljs.core.get.call(null,output_opts,new cljs.core.Keyword(null,"msg-fn","msg-fn",-1873033940),taoensso.timbre.default_output_msg_fn);
if(cljs.core.truth_(temp__5804__auto__)){
...
var temp__5804__auto____$1 = cljs.core.get.call(null,output_opts,new cljs.core.Keyword(null,"error-fn","error-fn",-171437615),taoensso.timbre.default_output_error_fn);
if(cljs.core.truth_(temp__5804__auto____$1)){
 ...
 */
taoensso.timbre.default_output_msg_fn = (function taoensso$timbre$default_output_msg_fn(p__19043){
var map__19044 = p__19043;
var map__19044__$1 = cljs.core.__destructure_map.call(null,map__19044);
var data = map__19044__$1;
var msg_type = cljs.core.get.call(null,map__19044__$1,new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822));
var _QMARK_msg_fmt = cljs.core.get.call(null,map__19044__$1,new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891));
var vargs = cljs.core.get.call(null,map__19044__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var output_opts = cljs.core.get.call(null,map__19044__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
var map__19046 = output_opts;
var map__19046__$1 = cljs.core.__destructure_map.call(null,map__19046);
var arg__GT_str_fn = cljs.core.get.call(null,map__19046__$1,new cljs.core.Keyword(null,"arg->str-fn","arg->str-fn",2064845310),taoensso.timbre.default_arg__GT_str_fn);
var G__19047 = msg_type;
if(cljs.core._EQ_.call(null,null,G__19047)){
return "";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"p","p",151049309),G__19047)){
return taoensso.timbre.str_join.call(null,arg__GT_str_fn,vargs);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),G__19047)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19047)].join('')));
 ...
 */
taoensso.timbre.default_output_error_fn = (function taoensso$timbre$default_output_error_fn(p__19048){
var map__19049 = p__19048;
var map__19049__$1 = cljs.core.__destructure_map.call(null,map__19049);
var data = map__19049__$1;
var _QMARK_err = cljs.core.get.call(null,map__19049__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var output_opts = cljs.core.get.call(null,map__19049__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
...
return taoensso.truss.impl._invar_violation_BANG_.call(null,true,new cljs.core.Symbol(null,"taoensso.timbre","taoensso.timbre",407940729,null),944,13,"/Users/AlexRoot-Roatch/current-projects/tic-tac-toe/resources/public/cljs/taoensso/timbre.cljc",new cljs.core.Keyword("taoensso.truss.impl","some?","taoensso.truss.impl/some?",1536228403),null,new cljs.core.Symbol(null,"?err","?err",-2104782470,null),_QMARK_err,e,null);
}
})();
var nl = "\n";
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(err.stack),(function (){var temp__5804__auto__ = cljs.core.ex_data.call(null,err);
if(cljs.core.truth_(temp__5804__auto__)){
...
})(),(function (){var temp__5804__auto__ = cljs.core.ex_cause.call(null,err);
if(cljs.core.truth_(temp__5804__auto__)){
...
var args__5732__auto__ = [];
var len__5726__auto___19057 = arguments.length;
var i__5727__auto___19058 = (0);
while(true){
if((i__5727__auto___19058 < len__5726__auto___19057)){
args__5732__auto__.push((arguments[i__5727__auto___19058]));

var G__19059 = (i__5727__auto___19058 + (1));
i__5727__auto___19058 = G__19059;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq19054){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq19054));
}));
