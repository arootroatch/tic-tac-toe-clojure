...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__9060 = c;
var G__9060__$1 = (((G__9060 == null))?null:G__9060.prototype);
if((G__9060__$1 == null)){
return null;
} else {
return G__9060__$1.render;
}
})() == null)))));
});
...
var G__9072 = c;
var G__9072__$1 = (((G__9072 == null))?null:G__9072.constructor);
if((G__9072__$1 == null)){
return null;
} else {
return G__9072__$1.name;
}
}
});
...
var c = this;
var G__9082_9084 = reagent.impl.component.goog$module$goog$object.get.call(null,c,"cljsRatom");
if((G__9082_9084 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__9082_9084);
}
...
var renders_9086 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9087 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_9086));
...
if((cljs.core.count.call(null,renders_9086) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_9086))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_9087)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_9087)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9085 = o;
reagent.impl.component.goog$module$goog$object.set.call(null,G__9085,cljs.core.name.call(null,k),v);
...
var _STAR_current_component_STAR__orig_val__9095 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9096 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9096);

try{return reagent.impl.component.functional_wrap_render.call(null,compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9095);
}});
...
var vec__9104 = reagent.impl.component.global$module$react.useState((0));
var _ = cljs.core.nth.call(null,vec__9104,(0),null);
var update_count = cljs.core.nth.call(null,vec__9104,(1),null);
...
var G__9108 = reagent.impl.component.goog$module$goog$object.get.call(null,reagent_state,"cljsRatom");
if((G__9108 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_.call(null,G__9108);
}
});
}),[]);
