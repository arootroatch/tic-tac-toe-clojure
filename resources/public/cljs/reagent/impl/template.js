...
var G__7912 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__7912,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__7914__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__7914 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__7915__i = 0, G__7915__a = new Array(arguments.length -  0);
while (G__7915__i < G__7915__a.length) {G__7915__a[G__7915__i] = arguments[G__7915__i + 0]; ++G__7915__i;}
  args = new cljs.core.IndexedSeq(G__7915__a,0,null);
} 
...
var G__7917 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__7917,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__7919__i < G__7919__a.length) {G__7919__a[G__7919__i] = arguments[G__7919__i + 0]; ++G__7919__i;}
  args = new cljs.core.IndexedSeq(G__7919__a,0,null);
} 
...
var G__7924 = props;
var G__7924__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__7924,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__7924);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__7924__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__7926 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__7926,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__7926;
}
})(),id_class);
...
var G__7927 = (cljs.core.count.call(null,argv) - first_child);
switch (G__7927) {
case (0):
...
var vec__7933 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__7933,(0),null);
var id = cljs.core.nth.call(null,vec__7933,(1),null);
var className = cljs.core.nth.call(null,vec__7933,(2),null);
...
var temp__5808__auto___7936 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___7936 == null)){
} else {
var key_7937 = temp__5808__auto___7936;
...
var temp__5808__auto___7942 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___7942 == null)){
} else {
var key_7943 = temp__5808__auto___7942;
(jsprops.key = key_7943);
}
...
var temp__5808__auto___7954 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___7954 == null)){
} else {
var key_7958 = temp__5808__auto___7954;
(jsprops.key = key_7958);
}
...
var temp__5808__auto___7966 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___7966 == null)){
} else {
var key_7967 = temp__5808__auto___7966;
(jsprops.key = key_7967);
}
...
var temp__5808__auto___7968 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___7968 == null)){
} else {
var key_7969 = temp__5808__auto___7968;
(jsprops.key = key_7969);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__7965_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__7965_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__7970 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__7970,(0),null);
var derefed = cljs.core.nth.call(null,vec__7970,(1),null);
...
break;
default:
var G__7975 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__7976 = compiler;
v = G__7975;
compiler = G__7976;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template7980 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template7980 = (function (opts,id,fn_to_element,parse_fn,meta7981){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta7981 = meta7981;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template7980.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_7982,meta7981__$1){
var self__ = this;
var _7982__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template7980(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta7981__$1));
}));

(reagent.impl.template.t_reagent$impl$template7980.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_7982){
var self__ = this;
var _7982__$1 = this;
return self__.meta7981;
}));

(reagent.impl.template.t_reagent$impl$template7980.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template7980.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template7980.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template7980.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template7980.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template7980.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta7981","meta7981",1418868001,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template7980.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template7980.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template7980");

(reagent.impl.template.t_reagent$impl$template7980.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write.call(null,writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template7980");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template7980.
 */
reagent.impl.template.__GT_t_reagent$impl$template7980 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template7980(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta7981){
return (new reagent.impl.template.t_reagent$impl$template7980(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta7981));
});

}

return (new reagent.impl.template.t_reagent$impl$template7980(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
