...
return (function() { 
var G__9140__delegate = function (args){
...
while (G__9149__i < G__9149__a.length) {G__9149__a[G__9149__i] = arguments[G__9149__i + 0]; ++G__9149__i;}
  args = new cljs.core.IndexedSeq(G__9149__a,0,null);
} 
...
var G__9147 = props;
var G__9147__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__9147,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9147);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__9147__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__9156 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__9156,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__9156;
}
})(),id_class);
...
var G__9161 = (cljs.core.count.call(null,argv) - first_child);
switch (G__9161) {
case (0):
...
var temp__5808__auto___9177 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___9177 == null)){
} else {
var key_9178 = temp__5808__auto___9177;
(jsprops.key = key_9178);
}
...
var temp__5808__auto___9182 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___9182 == null)){
} else {
var key_9183 = temp__5808__auto___9182;
(jsprops.key = key_9183);
}
...
break;
default:
var G__9202 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__9203 = compiler;
v = G__9202;
compiler = G__9203;
continue;
...
var G__9204 = tag;
var G__9204__$1 = (((G__9204 instanceof cljs.core.Keyword))?G__9204.fqn:null);
switch (G__9204__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template9217 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template9217 = (function (opts,id,fn_to_element,parse_fn,meta9218){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta9218 = meta9218;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template9217.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9219,meta9218__$1){
var self__ = this;
var _9219__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template9217(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta9218__$1));
}));

(reagent.impl.template.t_reagent$impl$template9217.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9219){
var self__ = this;
var _9219__$1 = this;
return self__.meta9218;
}));

(reagent.impl.template.t_reagent$impl$template9217.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template9217.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template9217.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template9217.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template9217.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template9217.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta9218","meta9218",70129588,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template9217.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template9217.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template9217");

(reagent.impl.template.t_reagent$impl$template9217.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write.call(null,writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template9217");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template9217.
 */
reagent.impl.template.__GT_t_reagent$impl$template9217 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template9217(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta9218){
return (new reagent.impl.template.t_reagent$impl$template9217(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta9218));
});

}

return (new reagent.impl.template.t_reagent$impl$template9217(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
