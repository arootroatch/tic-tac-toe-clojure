...
var G__16426 = (i__5727__auto___16424 + (1));
i__5727__auto___16424 = G__16426;
continue;
} else {
}
break;
...
/** @this {Function} */
(c3kit.wire.api.configure_BANG_.cljs$lang$applyTo = (function (seq16411){
...
var G__16429 = cljs.core.deref.call(null,c3kit.wire.api.config);
var G__16429__$1 = (((G__16429 == null))?null:new cljs.core.Keyword(null,"redirect-fn","redirect-fn",281458973).cljs$core$IFn$_invoke$arity$1(G__16429));
if((G__16429__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__16429__$1,uri);
}
});
...
c3kit.wire.api.handle_api_response = (function c3kit$wire$api$handle_api_response(raw_response,p__16446){
var map__16447 = p__16446;
var map__16447__$1 = cljs.core.__destructure_map.call(null,map__16447);
var handler = cljs.core.get.call(null,map__16447__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var options = cljs.core.get.call(null,map__16447__$1,new cljs.core.Keyword(null,"options","options",99638489));
...
var map__16448_16464 = c3kit.wire.apic.conform_response.call(null,raw_response);
var map__16448_16465__$1 = cljs.core.__destructure_map.call(null,map__16448_16464);
var status_16466 = cljs.core.get.call(null,map__16448_16465__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var flash_16467 = cljs.core.get.call(null,map__16448_16465__$1,new cljs.core.Keyword(null,"flash","flash",934660619));
var payload_16468 = cljs.core.get.call(null,map__16448_16465__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
var version_16469 = cljs.core.get.call(null,map__16448_16465__$1,new cljs.core.Keyword(null,"version","version",425292698));
var uri_16470 = cljs.core.get.call(null,map__16448_16465__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
if(cljs.core.seq.call(null,flash_16467)){
cljs.core.run_BANG_.call(null,c3kit.wire.flash.add_BANG_,flash_16467);
} else {
}

if(cljs.core.truth_((function (){var and__5000__auto__ = version_16469;
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.not_EQ_.call(null,version_16469,new cljs.core.Keyword(null,"version","version",425292698).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,c3kit.wire.api.config)));
} else {
return and__5000__auto__;
}
})())){
c3kit.wire.api.new_version_BANG_.call(null,version_16469);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"ok","ok",967785236),status_16466)){
c3kit.wire.api.handle_payload.call(null,handler,payload_16468);
} else {
}

if(((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"redirect","redirect",-1975673286),status_16466)) && (cljs.core.not.call(null,new cljs.core.Keyword(null,"no-redirect","no-redirect",-1477036586).cljs$core$IFn$_invoke$arity$1(options))))){
c3kit.wire.api.redirect.call(null,uri_16470);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1706214930),status_16466)){
var G__16454_16471 = options;
var G__16454_16472__$1 = (((G__16454_16471 == null))?null:new cljs.core.Keyword(null,"on-fail","on-fail",-589260753).cljs$core$IFn$_invoke$arity$1(G__16454_16471));
if((G__16454_16472__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__16454_16472__$1,payload_16468);
}
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",-978969032),status_16466)){
var G__16455_16473 = options;
var G__16455_16474__$1 = (((G__16455_16473 == null))?null:new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__16455_16473));
if((G__16455_16474__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__16455_16474__$1,payload_16468);
}
} else {
}

var G__16456 = options;
var G__16456__$1 = (((G__16456 == null))?null:new cljs.core.Keyword(null,"after-all","after-all",-54883998).cljs$core$IFn$_invoke$arity$1(G__16456));
if((G__16456__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__16456__$1);
}
});
