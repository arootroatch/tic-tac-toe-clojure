...
var seq__27352_27356 = cljs.core.seq.call(null,cljs.core.deref.call(null,c3kit.wire.spec_helper.render_roots));
var chunk__27353_27357 = null;
var count__27354_27358 = (0);
var i__27355_27359 = (0);
while(true){
if((i__27355_27359 < count__27354_27358)){
var root_27361 = cljs.core._nth.call(null,chunk__27353_27357,i__27355_27359);
reagent.dom.unmount_component_at_node.call(null,root_27361);


var G__27363 = seq__27352_27356;
var G__27364 = chunk__27353_27357;
var G__27365 = count__27354_27358;
var G__27366 = (i__27355_27359 + (1));
seq__27352_27356 = G__27363;
chunk__27353_27357 = G__27364;
count__27354_27358 = G__27365;
i__27355_27359 = G__27366;
continue;
} else {
var temp__5804__auto___27367 = cljs.core.seq.call(null,seq__27352_27356);
if(temp__5804__auto___27367){
var seq__27352_27368__$1 = temp__5804__auto___27367;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__27352_27368__$1)){
var c__5525__auto___27369 = cljs.core.chunk_first.call(null,seq__27352_27368__$1);
var G__27370 = cljs.core.chunk_rest.call(null,seq__27352_27368__$1);
var G__27371 = c__5525__auto___27369;
var G__27372 = cljs.core.count.call(null,c__5525__auto___27369);
var G__27373 = (0);
seq__27352_27356 = G__27370;
chunk__27353_27357 = G__27371;
count__27354_27358 = G__27372;
i__27355_27359 = G__27373;
continue;
} else {
var root_27374 = cljs.core.first.call(null,seq__27352_27368__$1);
reagent.dom.unmount_component_at_node.call(null,root_27374);


var G__27375 = cljs.core.next.call(null,seq__27352_27368__$1);
var G__27376 = null;
var G__27377 = (0);
var G__27378 = (0);
seq__27352_27356 = G__27375;
chunk__27353_27357 = G__27376;
count__27354_27358 = G__27377;
i__27355_27359 = G__27378;
continue;
}
} else {
}
...
var slice = (function (p1__27382_SHARP_){
return Array.prototype.slice.call(p1__27382_SHARP_);
});
...
var G__27543 = c3kit.wire.spec_helper.select.call(null,selector_or_elem);
if((G__27543 == null)){
return null;
} else {
return c3kit.wire.js.node_text.call(null,G__27543);
}
} else {
...
var G__27544 = c3kit.wire.spec_helper.select.call(null,root,selector);
if((G__27544 == null)){
return null;
} else {
return c3kit.wire.js.node_text.call(null,G__27544);
}
}));
...
return speclj.components.new_around.call(null,(function (it__26687__auto__){
var post_BANG__orig_val__27588 = c3kit.wire.ajax.post_BANG_;
var get_BANG__orig_val__27589 = c3kit.wire.ajax.get_BANG_;
var post_BANG__temp_val__27590 = speclj.stub.stub.call(null,new cljs.core.Keyword("ajax","post!","ajax/post!",-369377915),cljs.core.PersistentArrayMap.EMPTY);
var get_BANG__temp_val__27591 = speclj.stub.stub.call(null,new cljs.core.Keyword("ajax","get!","ajax/get!",1836236045),cljs.core.PersistentArrayMap.EMPTY);
(c3kit.wire.ajax.post_BANG_ = post_BANG__temp_val__27590);

(c3kit.wire.ajax.get_BANG_ = get_BANG__temp_val__27591);

try{return it__26687__auto__.call(null);
}finally {(c3kit.wire.ajax.get_BANG_ = get_BANG__orig_val__27589);

(c3kit.wire.ajax.post_BANG_ = post_BANG__orig_val__27588);
}}));
});
...
var G__27592 = c3kit.wire.spec_helper.last_ajax_post_handler.call(null);
if((G__27592 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__27592,payload);
}
});
c3kit.wire.spec_helper.invoke_last_ajax_get_handler = (function c3kit$wire$spec_helper$invoke_last_ajax_get_handler(payload){
var G__27593 = c3kit.wire.spec_helper.last_ajax_get_handler.call(null);
if((G__27593 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__27593,payload);
}
});
c3kit.wire.spec_helper.stub_ws = (function c3kit$wire$spec_helper$stub_ws(){
return speclj.components.new_around.call(null,(function (it__26687__auto__){
var call_BANG__orig_val__27594 = c3kit.wire.websocket.call_BANG_;
var call_BANG__temp_val__27595 = speclj.stub.stub.call(null,new cljs.core.Keyword("ws","call!","ws/call!",1190060416),cljs.core.PersistentArrayMap.EMPTY);
(c3kit.wire.websocket.call_BANG_ = call_BANG__temp_val__27595);

try{return it__26687__auto__.call(null);
}finally {(c3kit.wire.websocket.call_BANG_ = call_BANG__orig_val__27594);
}}));
});
...
var G__27596 = c3kit.wire.spec_helper.last_ws_call_handler.call(null);
if((G__27596 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__27596,payload);
}
});
