...
return cljs.core._write.call(null,writer__5288__auto__,"speclj.platform/SpecFailure");
}));
...
return cljs.core._write.call(null,writer__5288__auto__,"speclj.platform/SpecPending");
}));
...
return cljs.core.rest.call(null,clojure.string.split_lines.call(null,(function (){var or__5002__auto__ = e.stack;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return e.toString();
...
return cljs.core.println.call(null,(function (){var or__5002__auto__ = e.stack;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
