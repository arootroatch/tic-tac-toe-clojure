...
var G__20393 = name_or_object;
if(speclj.config.load_reporter_by_name_QMARK_.call(null,name_or_object)){
return speclj.config.load_reporter_by_name.call(null,G__20393);
} else {
return G__20393;
}
});
...
var vec__20394 = speclj.config.parse_tag.call(null,tag);
var flag = cljs.core.nth.call(null,vec__20394,(0),null);
var value = cljs.core.nth.call(null,vec__20394,(1),null);
...
var _STAR_runner_STAR__orig_val__20400 = speclj.config._STAR_runner_STAR_;
var _STAR_reporters_STAR__orig_val__20401 = speclj.config._STAR_reporters_STAR_;
var _STAR_specs_STAR__orig_val__20402 = speclj.config._STAR_specs_STAR_;
var _STAR_color_QMARK__STAR__orig_val__20403 = speclj.config._STAR_color_QMARK__STAR_;
var _STAR_omit_pending_QMARK__STAR__orig_val__20404 = speclj.config._STAR_omit_pending_QMARK__STAR_;
var _STAR_full_stack_trace_QMARK__STAR__orig_val__20405 = speclj.config._STAR_full_stack_trace_QMARK__STAR_;
var _STAR_tag_filter_STAR__orig_val__20406 = speclj.config._STAR_tag_filter_STAR_;
var _STAR_runner_STAR__temp_val__20407 = (cljs.core.truth_(new cljs.core.Keyword(null,"runner","runner",1945441304).cljs$core$IFn$_invoke$arity$1(config))?(function (){
...
var _STAR_reporters_STAR__temp_val__20408 = (cljs.core.truth_(new cljs.core.Keyword(null,"reporters","reporters",-373999166).cljs$core$IFn$_invoke$arity$1(config))?cljs.core.mapv.call(null,speclj.config.load_reporter,new cljs.core.Keyword(null,"reporters","reporters",-373999166).cljs$core$IFn$_invoke$arity$1(config)):speclj.config.active_reporters.call(null));
var _STAR_specs_STAR__temp_val__20409 = new cljs.core.Keyword(null,"specs","specs",1426570741).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_color_QMARK__STAR__temp_val__20410 = new cljs.core.Keyword(null,"color","color",1011675173).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_omit_pending_QMARK__STAR__temp_val__20411 = new cljs.core.Keyword(null,"omit-pending","omit-pending",-1591740250).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_full_stack_trace_QMARK__STAR__temp_val__20412 = (!((new cljs.core.Keyword(null,"stacktrace","stacktrace",-95588394).cljs$core$IFn$_invoke$arity$1(config) == null)));
var _STAR_tag_filter_STAR__temp_val__20413 = speclj.config.parse_tags.call(null,new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(config));
(speclj.config._STAR_runner_STAR_ = _STAR_runner_STAR__temp_val__20407);

(speclj.config._STAR_reporters_STAR_ = _STAR_reporters_STAR__temp_val__20408);

(speclj.config._STAR_specs_STAR_ = _STAR_specs_STAR__temp_val__20409);

(speclj.config._STAR_color_QMARK__STAR_ = _STAR_color_QMARK__STAR__temp_val__20410);

(speclj.config._STAR_omit_pending_QMARK__STAR_ = _STAR_omit_pending_QMARK__STAR__temp_val__20411);

(speclj.config._STAR_full_stack_trace_QMARK__STAR_ = _STAR_full_stack_trace_QMARK__STAR__temp_val__20412);

(speclj.config._STAR_tag_filter_STAR_ = _STAR_tag_filter_STAR__temp_val__20413);

try{return action.call(null);
}finally {(speclj.config._STAR_tag_filter_STAR_ = _STAR_tag_filter_STAR__orig_val__20406);

(speclj.config._STAR_full_stack_trace_QMARK__STAR_ = _STAR_full_stack_trace_QMARK__STAR__orig_val__20405);

(speclj.config._STAR_omit_pending_QMARK__STAR_ = _STAR_omit_pending_QMARK__STAR__orig_val__20404);

(speclj.config._STAR_color_QMARK__STAR_ = _STAR_color_QMARK__STAR__orig_val__20403);

(speclj.config._STAR_specs_STAR_ = _STAR_specs_STAR__orig_val__20402);

(speclj.config._STAR_reporters_STAR_ = _STAR_reporters_STAR__orig_val__20401);

(speclj.config._STAR_runner_STAR_ = _STAR_runner_STAR__orig_val__20400);
}});
