...
var G__12931 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12931,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12931;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12933){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12934,G__12935,seq12933__$2);
}));
...
var map__12940 = m;
var map__12940__$1 = cljs.core.__destructure_map.call(null,map__12940);
var file = cljs.core.get.call(null,map__12940__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12940__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12940__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__12939_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12939_SHARP_));
...
var temp__5804__auto___12941 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___12941)){
var message_12942 = temp__5804__auto___12941;
cljs.core.println.call(null,message_12942);
} else {
}
...
var temp__5804__auto___12943 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___12943)){
var message_12944 = temp__5804__auto___12943;
cljs.core.println.call(null,message_12944);
} else {
}
...
var output_dir__$1 = (function (){var G__12945 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__12945,"/"].join('');
} else {
return G__12945;
}
})();
...
var temp__5802__auto__ = new cljs.core.Keyword(null,"source-map","source-map",1706252311).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(temp__5802__auto__)){
var source_map = temp__5802__auto__;
var temp__5802__auto____$1 = cljs.core.get_in.call(null,source_map,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [filename,(line - (1))], null));
if(cljs.core.truth_(temp__5802__auto____$1)){
var columns = temp__5802__auto____$1;
return cljs.core.vec.call(null,cljs.core.map.call(null,cljs.core.first.call(null,(function (){var temp__5802__auto____$2 = cljs.core.get.call(null,columns,(column - (1)));
...
var G__12946 = exception.stack;
var G__12946__$1 = (((G__12946 == null))?null:clojure.string.split_lines.call(null,G__12946));
var G__12946__$2 = (((G__12946__$1 == null))?null:cljs.core.get.call(null,G__12946__$1,depth));
if((G__12946__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12946__$2);
}
} else {
...
var vec__12947 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12947,(0),null);
var column = cljs.core.nth.call(null,vec__12947,(1),null);
var vec__12950 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12950,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12950,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12950,(2),null);
...
var m__$1 = (function (){var G__12953 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
while(true){
var temp__5804__auto__ = cljs.core.seq.call(null,fns);
if(temp__5804__auto__){
var xs__6360__auto__ = temp__5804__auto__;
var f = cljs.core.first.call(null,xs__6360__auto__);
var obj = f.call(null);
if(cljs.test.async_QMARK_.call(null,obj)){
return obj.call(null,(function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6360__auto__,temp__5804__auto__){
return (function (){
...
var G__12958 = (function (){var G__12956 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12956);
} else {
return G__12956;
}
})();
...
return cljs.core.vary_meta.call(null,G__12957,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var temp__5802__auto__ = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5802__auto__)){
...
var vec__12962 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12962,(0),null);
var types = vec__12962;
...
return cljs.core.map.call(null,(function (p__12965){
var vec__12966 = p__12965;
var ns = cljs.core.nth.call(null,vec__12966,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12966,(1),null);
return (function (){
...
var G__12969 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__12970 = cljs.core.seq.call(null,vars__$1);
var chunk__12971 = null;
var count__12972 = (0);
var i__12973 = (0);
while(true){
if((i__12973 < count__12972)){
var v = cljs.core._nth.call(null,chunk__12971,i__12973);
var temp__5804__auto___12975 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5804__auto___12975)){
var t_12976 = temp__5804__auto___12975;
each_fixture_fn.call(null,((function (seq__12970,chunk__12971,count__12972,i__12973,t_12976,temp__5804__auto___12975,v,each_fixture_fn,G__12969,G__12969__$1,env,once_fixtures,each_fixtures,vec__12966,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12976)));
});})(seq__12970,chunk__12971,count__12972,i__12973,t_12976,temp__5804__auto___12975,v,each_fixture_fn,G__12969,G__12969__$1,env,once_fixtures,each_fixtures,vec__12966,ns,vars__$1))
);
} else {
}


var G__12977 = seq__12970;
var G__12978 = chunk__12971;
var G__12979 = count__12972;
var G__12980 = (i__12973 + (1));
seq__12970 = G__12977;
chunk__12971 = G__12978;
count__12972 = G__12979;
i__12973 = G__12980;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq.call(null,seq__12970);
if(temp__5804__auto__){
var seq__12970__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12970__$1)){
var c__5525__auto__ = cljs.core.chunk_first.call(null,seq__12970__$1);
var G__12981 = cljs.core.chunk_rest.call(null,seq__12970__$1);
var G__12982 = c__5525__auto__;
var G__12983 = cljs.core.count.call(null,c__5525__auto__);
var G__12984 = (0);
seq__12970 = G__12981;
chunk__12971 = G__12982;
count__12972 = G__12983;
i__12973 = G__12984;
continue;
} else {
var v = cljs.core.first.call(null,seq__12970__$1);
var temp__5804__auto___12985__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5804__auto___12985__$1)){
var t_12986 = temp__5804__auto___12985__$1;
each_fixture_fn.call(null,((function (seq__12970,chunk__12971,count__12972,i__12973,t_12986,temp__5804__auto___12985__$1,v,seq__12970__$1,temp__5804__auto__,each_fixture_fn,G__12969,G__12969__$1,env,once_fixtures,each_fixtures,vec__12966,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12986)));
});})(seq__12970,chunk__12971,count__12972,i__12973,t_12986,temp__5804__auto___12985__$1,v,seq__12970__$1,temp__5804__auto__,each_fixture_fn,G__12969,G__12969__$1,env,once_fixtures,each_fixtures,vec__12966,ns,vars__$1))
);
} else {
}


var G__12987 = cljs.core.next.call(null,seq__12970__$1);
var G__12988 = null;
var G__12989 = (0);
var G__12990 = (0);
seq__12970 = G__12987;
chunk__12971 = G__12988;
count__12972 = G__12989;
i__12973 = G__12990;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12969__$1)].join('')));
