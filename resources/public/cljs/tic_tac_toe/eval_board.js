...
return cljs.core.concat.call(null,cljs.core.partition.call(null,(3),board),cljs.core.map.call(null,(function (p1__16024_SHARP_){
return cljs.core.take_nth.call(null,(3),cljs.core.drop.call(null,p1__16024_SHARP_,board));
...
return cljs.core.concat.call(null,cljs.core.partition.call(null,(4),board),cljs.core.map.call(null,(function (p1__16025_SHARP_){
return cljs.core.take_nth.call(null,(4),cljs.core.drop.call(null,p1__16025_SHARP_,board));
...
return cljs.core.concat.call(null,cljs.core.map.call(null,(function (p1__16026_SHARP_){
return cljs.core.take.call(null,(3),cljs.core.take_nth.call(null,(4),cljs.core.drop.call(null,p1__16026_SHARP_,board)));
}),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(9),(18)], null)),cljs.core.map.call(null,(function (p1__16027_SHARP_){
return cljs.core.take.call(null,(3),cljs.core.take_nth.call(null,(2),cljs.core.drop.call(null,p1__16027_SHARP_,board)));
...
return cljs.core.concat.call(null,cljs.core.partition.call(null,(3),board),cljs.core.map.call(null,(function (p1__16028_SHARP_){
return cljs.core.take.call(null,(3),cljs.core.take_nth.call(null,(3),cljs.core.drop.call(null,p1__16028_SHARP_,board)));
}),new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(1),(2),(9),(10),(11),(18),(19),(20)], null)),tic_tac_toe.eval_board.__GT_2D_diagonals.call(null,board),tic_tac_toe.eval_board.__GT_3D_diagonals.call(null,board),cljs.core.map.call(null,(function (p1__16029_SHARP_){
return cljs.core.take_nth.call(null,(9),cljs.core.drop.call(null,p1__16029_SHARP_,board));
...
if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__16030_SHARP_){
return cljs.core.every_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"x","x",2099068185),null], null), null),p1__16030_SHARP_);
}),paths))){
return "X wins!";
} else {
if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__16031_SHARP_){
return cljs.core.every_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"o","o",-1350007228),null], null), null),p1__16031_SHARP_);
}),paths))){
return "O wins!";
} else {
...
if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__16033_SHARP_){
return cljs.core.every_QMARK_.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([minimizer]),p1__16033_SHARP_);
}),paths))){
return ((-10) + depth);
} else {
if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__16034_SHARP_){
return cljs.core.every_QMARK_.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([maximizer]),p1__16034_SHARP_);
}),paths))){
return ((10) - depth);
} else {
if(cljs.core.every_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"x","x",2099068185),null], null), null),board)){
