...
return cljs.core.reduce.call(null,(function (result,p__16985){
var vec__16986 = p__16985;
var k = cljs.core.nth.call(null,vec__16986,(0),null);
var v = cljs.core.nth.call(null,vec__16986,(1),null);
...
var vec__16989 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__16989,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__16989,(1),null);
var ab = cljs.core.nth.call(null,vec__16989,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_17005 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_17005.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_17014 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_17014.call(null,a,b);
}
});
...
return (function (){var G__17040 = clojure.data.equality_partition.call(null,a);
var G__17040__$1 = (((G__17040 instanceof cljs.core.Keyword))?G__17040.fqn:null);
switch (G__17040__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17040__$1)].join('')));
