...
return cljs.core.reduce.call(null,(function (result,p__14953){
...
var vec__14958 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__14958,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__14958,(1),null);
var ab = cljs.core.nth.call(null,vec__14958,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_14985 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_14985.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_14986 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_14986.call(null,a,b);
}
});
...
return (function (){var G__15022 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15022__$1)].join('')));
