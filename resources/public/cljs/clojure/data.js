...
return cljs.core.reduce.call(null,(function (result,p__16905){
var vec__16906 = p__16905;
var k = cljs.core.nth.call(null,vec__16906,(0),null);
var v = cljs.core.nth.call(null,vec__16906,(1),null);
...
var vec__16912 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__16912,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__16912,(1),null);
var ab = cljs.core.nth.call(null,vec__16912,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_16957 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_16957.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_16974 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_16974.call(null,a,b);
}
});
...
return (function (){var G__16978 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16978__$1)].join('')));
