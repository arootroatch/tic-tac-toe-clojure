...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__15785){
var map__15786 = p__15785;
var map__15786__$1 = cljs.core.__destructure_map(map__15786);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15786__$1,cljs.core.cst$kw$on_DASH_write);
...
var _STAR_force_set_dom_value_STAR__orig_val__15787 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__15788 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__15788);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__15787);
}}));
} else {
...
(jsprops.onChange = (function (p1__15789_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__15789_SHARP_);
}));
