...
var i_13459 = (self__.level + (1));
while(true){
if((i_13459 <= (new_level + (1)))){
(update[i_13459] = self__.header);

var G__13460 = (i_13459 + (1));
i_13459 = G__13460;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_13461 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13461[i]));
} else {
x__$2.forward.push((((i < links_13461.length))?(links_13461[i]):null));
}

if((i < links_13461.length)){
(links_13461[i] = x__$2);
} else {
links_13461.push(x__$2);
}
...
var i_13463 = (0);
while(true){
if((i_13463 <= self__.level)){
var links_13464 = (update[i_13463]).forward;
if((x__$1 === (((i_13463 < links_13464.length))?(links_13464[i_13463]):null))){
(links_13464[i_13463] = (x__$1.forward[i_13463]));

var G__13465 = (i_13463 + (1));
i_13463 = G__13465;
continue;
} else {
var G__13466 = (i_13463 + (1));
i_13463 = G__13466;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__13473 = nx;
var G__13474 = (level__$1 - (1));
x = G__13473;
level__$1 = G__13474;
continue;
} else {
var G__13475 = x;
var G__13476 = (level__$1 - (1));
x = G__13475;
level__$1 = G__13476;
continue;
}
