...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10671 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10671(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10672 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10672(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10673 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10673(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10674 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10674(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10675 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10675(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10676 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10676(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10677 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10677(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10678 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10678(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10679 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10679(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10680 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10680(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10681 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10681(b);
}
});
