...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11223 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11223(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11224 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11224(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11225 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11225(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11226 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11226(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11227 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11227(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11228 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11228(reader);
}
});
...
var G__11239 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11240 = s.append(c);
c = G__11239;
s = G__11240;
continue;
}
